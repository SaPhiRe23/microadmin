...
export default defineConfig(({ mode }) => {
  ...
  const PLAY_WITH_DOCKER_BACKEND = 'http://ip172-18-0-XX-XXXXXX-5000.direct.labs.play-with-docker.com/api';
  ...
  return {
    ...
    server: {
      ...
      host: true,
      allowedHosts: [
        "'http://ip172-18-0-XX-XXXXXX-5173.direct.labs.play-with-docker.com/api'",
        "localhost",
        "0.0.0.0",
      ],
    },
